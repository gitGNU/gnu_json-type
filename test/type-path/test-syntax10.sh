...
# $ json-gentest -C type-path:syntax10
#
...
echo '$ json <<< '\''"$foo[0"'\'''
json <<< '"$foo[0"' 2>&1 ||
echo 'command failed: json <<< '\''"$foo[0"'\'''
...
echo '$ json <<< '\''"$foo[1234567890123456789012345678901234567890]"'\'''
json <<< '"$foo[1234567890123456789012345678901234567890]"' 2>&1 ||
echo 'command failed: json <<< '\''"$foo[1234567890123456789012345678901234567890]"'\'''
)
