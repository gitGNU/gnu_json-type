...
# $ json-gentest -C type-checker:closed-array-closed-array
#
...
diff -u$u -L closed-array-closed-array.old <(echo \
...
$ json -d '\''{"type":"array","args":[{"type":"array","args":["array"]}]}'\'' <<< '\''[[[]]]'\''
[[[]]]'
) -L closed-array-closed-array.new <(
...
echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[false]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[false]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[[false]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[false]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[true]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[[true]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[true]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[123]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '[[123]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''[[123]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["null"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[null]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '[null]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[null]'\'''
...
echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[[true]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '[[true]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[[true]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[[123]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '[[123]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''[[123]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["boolean"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[null]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[null]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[null]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[null]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[[null]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[null]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[false]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[false]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[[false]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[false]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[true]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[[true]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[true]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[123]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '[[123]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''[[123]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["number"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[null]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[null]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[null]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[null]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[[null]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[null]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[false]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[false]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[[false]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[false]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[true]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[[true]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[true]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[123]]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '[[123]]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''[[123]]'\'''

echo '$ json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":[{"type":"array","args":["string"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''["foo"]'\'''
