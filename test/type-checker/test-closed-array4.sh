...
# $ json-gentest -C type-checker:closed-array4
#
...
diff -u$u -L closed-array4.old <(echo \
...
echo '$ json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["type"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["type"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["type"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["type"]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"array","args":["null"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["null"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["null"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["null"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["null"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["null"]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["boolean"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["boolean"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["boolean"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["boolean"]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["number"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["number"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["number"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["number"]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["string"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["string"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["string"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["string"]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["object"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["object"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["object"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["object"]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''[123]'\'''
json -d '{"type":"array","args":["array"]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"array","args":["array"]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''["foo"]'\'''

echo '$ json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"array","args":["array"]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"array","args":["array"]}'\'' <<< '\''[{}]'\'''
