...
# $ json-gentest -C type-checker:dict-open-array2
#
...
diff -u$u -L dict-open-array2.old <(echo \
...
echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,null]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}' <<< '{"foo":[null,null]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,null]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,false]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}' <<< '{"foo":[null,false]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,false]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,true]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}' <<< '{"foo":[null,true]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,true]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,123]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}' <<< '{"foo":[null,123]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,123]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,"bar"]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}' <<< '{"foo":[null,"bar"]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"null"}}]}'\'' <<< '\''{"foo":[null,"bar"]}'\'''
...
echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,null]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}' <<< '{"foo":[false,null]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,null]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,false]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}' <<< '{"foo":[false,false]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,false]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,true]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}' <<< '{"foo":[false,true]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,true]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,123]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}' <<< '{"foo":[false,123]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,123]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,"bar"]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}' <<< '{"foo":[false,"bar"]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"boolean"}}]}'\'' <<< '\''{"foo":[false,"bar"]}'\'''
...
echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,null]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,null]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,null]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,false]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,false]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,false]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,true]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,true]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,true]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,123]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,123]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,123]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,"bar"]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,"bar"]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,"bar"]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,{}]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,{}]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,{}]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,[]]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}' <<< '{"foo":[456,[]]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"number"}}]}'\'' <<< '\''{"foo":[456,[]]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",null]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}' <<< '{"foo":["bar",null]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",null]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",false]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}' <<< '{"foo":["bar",false]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",false]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",true]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}' <<< '{"foo":["bar",true]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",true]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",123]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}' <<< '{"foo":["bar",123]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar",123]}'\'''

echo '$ json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar","bar"]}'\'''
json -d '{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}' <<< '{"foo":["bar","bar"]}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"dict","args":[{"name":"foo","type":{"type":"array","args":"string"}}]}'\'' <<< '\''{"foo":["bar","bar"]}'\'''
