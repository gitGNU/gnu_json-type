...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"type":"array","args":["number"]}},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":{"type":"array","args":["number"]}},{"type":"array","args":[{"type":"array","args":"string"}]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"type":"array","args":["number"]}},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'''
)
