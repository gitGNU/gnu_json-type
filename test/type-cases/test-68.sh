...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"plain":1}},{"type":"array","args":["number"]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":{"plain":1}},{"type":"array","args":["number"]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"plain":1}},{"type":"array","args":["number"]}]}'\'''
)
