...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}'\'''
)
