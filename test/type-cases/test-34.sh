...
echo '$ json -d '\''{"type":"list","args":[{"type":"object","args":[]}]}'\'' <<< '\''{}'\'''
json -d '{"type":"list","args":[{"type":"object","args":[]}]}' <<< '{}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"object","args":[]}]}'\'' <<< '\''{}'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"object","args":[]}]}'\'' <<< '\''{"bar":false}'\'''
json -d '{"type":"list","args":[{"type":"object","args":[]}]}' <<< '{"bar":false}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"object","args":[]}]}'\'' <<< '\''{"bar":false}'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"}]},{"type":"object","args":[]}]}'\'' <<< '\''{"bar":false}'\'''
json -d '{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"}]},{"type":"object","args":[]}]}' <<< '{"bar":false}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"}]},{"type":"object","args":[]}]}'\'' <<< '\''{"bar":false}'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"object","args":[]},{"type":"object","args":[{"name":"foo","type":"null"}]}]}'\'' <<< '\''{"bar":false}'\'''
json -d '{"type":"list","args":[{"type":"object","args":[]},{"type":"object","args":[{"name":"foo","type":"null"}]}]}' <<< '{"bar":false}' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"object","args":[]},{"type":"object","args":[{"name":"foo","type":"null"}]}]}'\'' <<< '\''{"bar":false}'\'''
)
