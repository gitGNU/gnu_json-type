...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":"array"},{"type":"array","args":[{"type":"array","args":[]}]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":"array"},{"type":"array","args":[{"type":"array","args":[]}]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":"array"},{"type":"array","args":[{"type":"array","args":[]}]}]}'\'''
)
