...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":[{"plain":0},"number"]},{"type":"array","args":[{"plain":0},{"plain":1}]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":[{"plain":0},"number"]},{"type":"array","args":[{"plain":0},{"plain":1}]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":[{"plain":0},"number"]},{"type":"array","args":[{"plain":0},{"plain":1}]}]}'\'''
)
