...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'' <<< '\''[null]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}' <<< '[null]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'' <<< '\''[null]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"null"},{"type":"array","args":[{"type":"array","args":"string"}]}]}'\'' <<< '\''[false]'\'''
