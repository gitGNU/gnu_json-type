...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":"number"}]},{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":{"plain":1}}]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":"number"}]},{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":{"plain":1}}]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":"number"}]},{"type":"object","args":[{"name":"foo","type":"type"},{"name":"bar","type":{"plain":1}}]}]}'\'''
)
