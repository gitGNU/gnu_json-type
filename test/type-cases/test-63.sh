...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"},{"name":"bar","type":{"type":"list","args":["number"]}}]}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"},{"name":"bar","type":{"type":"list","args":["number"]}}]}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"object","args":[{"name":"foo","type":"null"},{"name":"bar","type":{"type":"list","args":["number"]}}]}]}'\'''
)
