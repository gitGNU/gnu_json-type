...
# $ json-gentest -C type-checker-list:list-closed-array-plain-closed-array-plain-val-array-basic
#
...
diff -u$u -L list-closed-array-plain-closed-array-plain-val-array-basic.old <(echo \
...
[
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":[{"plain":"foo"}]},{"type":"array","args":[{"plain":"bar"}]}]}'\'' <<< '\''[[]]'\'''
) -L list-closed-array-plain-closed-array-plain-val-array-basic.new <(
