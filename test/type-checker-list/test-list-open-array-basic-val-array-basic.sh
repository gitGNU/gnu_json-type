...
# $ json-gentest -C type-checker-list:list-open-array-basic-val-array-basic
#
...
diff -u$u -L list-open-array-basic-val-array-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":"array"}]}'\'' <<< '\''[[]]'\''
[[]]'
) -L list-open-array-basic-val-array-basic.new <(
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"type"}]}'\'' <<< '\''["bar"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"type"}]}' <<< '["bar"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"type"}]}'\'' <<< '\''["bar"]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"null"}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"null"}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"null"}]}'\'' <<< '\''[123]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"boolean"}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"boolean"}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''["bar"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"boolean"}]}' <<< '["bar"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''["bar"]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"boolean"}]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"boolean"}]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"number"}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[false]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"number"}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"number"}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[123]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''["bar"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"number"}]}' <<< '["bar"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''["bar"]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"number"}]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"number"}]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[false]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"string"}]}' <<< '[false]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[false]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[true]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"string"}]}' <<< '[true]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[true]'\'''

echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[123]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"string"}]}' <<< '[123]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[123]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[{}]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"string"}]}' <<< '[{}]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"string"}]}'\'' <<< '\''[{}]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"object"}]}'\'' <<< '\''["bar"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"object"}]}' <<< '["bar"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"object"}]}'\'' <<< '\''["bar"]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":"array"}]}'\'' <<< '\''["bar"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":"array"}]}' <<< '["bar"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":"array"}]}'\'' <<< '\''["bar"]'\'''
