...
# $ json-gentest -C type-checker-list:list-closed-array-basic-val-array-basic
#
...
diff -u$u -L list-closed-array-basic-val-array-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":["array"]}]}'\'' <<< '\''[[]]'\''
[[]]'
) -L list-closed-array-basic-val-array-basic.new <(
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":["null"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["null"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":["boolean"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["boolean"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":["number"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["number"]}]}'\'' <<< '\''["foo"]'\'''
...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''["foo"]'\'''
json -d '{"type":"list","args":[{"type":"array","args":["string"]}]}' <<< '["foo"]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["string"]}]}'\'' <<< '\''["foo"]'\'''
