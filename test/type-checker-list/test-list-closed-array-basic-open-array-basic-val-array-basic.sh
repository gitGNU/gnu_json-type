...
# $ json-gentest -C type-checker-list:list-closed-array-basic-open-array-basic-val-array-basic
#
...
diff -u$u -L list-closed-array-basic-open-array-basic-val-array-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":["array"]},{"type":"array","args":"object"}]}'\'' <<< '\''[[]]'\''
[[]]'
) -L list-closed-array-basic-open-array-basic-val-array-basic.new <(
