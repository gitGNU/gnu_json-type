...
# $ json-gentest -C type-checker-list:list-open-array-basic-open-array-plain-val-basic
#
...
diff -u$u -L list-open-array-basic-open-array-plain-val-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":"array"},{"type":"array","args":{"plain":"foo"}}]}'\'' <<< '\''[]'\''
[]'
) -L list-open-array-basic-open-array-plain-val-basic.new <(
