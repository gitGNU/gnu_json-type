...
# $ json-gentest -C type-checker-list:list-plain-open-array-plain-val-array-empty
#
...
diff -u$u -L list-plain-open-array-plain-val-array-empty.old <(echo \
...
[]'
) -L list-plain-open-array-plain-val-array-empty.new <(
