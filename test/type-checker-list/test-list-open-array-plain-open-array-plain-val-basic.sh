...
# $ json-gentest -C type-checker-list:list-open-array-plain-open-array-plain-val-basic
#
...
diff -u$u -L list-open-array-plain-open-array-plain-val-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":{"plain":"foo"}},{"type":"array","args":{"plain":"bar"}}]}'\'' <<< '\''[]'\''
[]'
) -L list-open-array-plain-open-array-plain-val-basic.new <(
