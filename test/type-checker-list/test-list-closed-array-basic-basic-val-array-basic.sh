...
# $ json-gentest -C type-checker-list:list-closed-array-basic-basic-val-array-basic
#
...
diff -u$u -L list-closed-array-basic-basic-val-array-basic.old <(echo \
...
[[]
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["array","array"]}]}'\'' <<< '\''[[]]'\'''
) -L list-closed-array-basic-basic-val-array-basic.new <(
