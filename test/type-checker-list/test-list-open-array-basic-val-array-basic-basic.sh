...
# $ json-gentest -C type-checker-list:list-open-array-basic-val-array-basic-basic
#
...
diff -u$u -L list-open-array-basic-val-array-basic-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":"array"}]}'\'' <<< '\''[[],[]]'\''
[[],[]]'
) -L list-open-array-basic-val-array-basic-basic.new <(
