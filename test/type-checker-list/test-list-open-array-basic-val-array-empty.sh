...
# $ json-gentest -C type-checker-list:list-open-array-basic-val-array-empty
#
...
diff -u$u -L list-open-array-basic-val-array-empty.old <(echo \
...
[]'
) -L list-open-array-basic-val-array-empty.new <(
