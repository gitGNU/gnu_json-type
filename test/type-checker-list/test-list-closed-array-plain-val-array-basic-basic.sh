...
# $ json-gentest -C type-checker-list:list-closed-array-plain-val-array-basic-basic
#
...
diff -u$u -L list-closed-array-plain-val-array-basic-basic.old <(echo \
...
["foo"
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":[{"plain":"foo"}]}]}'\'' <<< '\''["foo",[]]'\'''
) -L list-closed-array-plain-val-array-basic-basic.new <(
