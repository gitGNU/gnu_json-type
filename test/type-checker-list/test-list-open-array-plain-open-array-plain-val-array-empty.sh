...
# $ json-gentest -C type-checker-list:list-open-array-plain-open-array-plain-val-array-empty
#
...
diff -u$u -L list-open-array-plain-open-array-plain-val-array-empty.old <(echo \
...
[]'
) -L list-open-array-plain-open-array-plain-val-array-empty.new <(
