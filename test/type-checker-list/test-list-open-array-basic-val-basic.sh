...
# $ json-gentest -C type-checker-list:list-open-array-basic-val-basic
#
...
diff -u$u -L list-open-array-basic-val-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":"array"}]}'\'' <<< '\''[]'\''
[]'
) -L list-open-array-basic-val-basic.new <(
