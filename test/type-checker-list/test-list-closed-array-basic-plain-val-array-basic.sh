...
# $ json-gentest -C type-checker-list:list-closed-array-basic-plain-val-array-basic
#
...
diff -u$u -L list-closed-array-basic-plain-val-array-basic.old <(echo \
...
[[]
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["array",{"plain":"foo"}]}]}'\'' <<< '\''[[]]'\'''
) -L list-closed-array-basic-plain-val-array-basic.new <(
