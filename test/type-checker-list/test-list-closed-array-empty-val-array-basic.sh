...
# $ json-gentest -C type-checker-list:list-closed-array-empty-val-array-basic
#
...
diff -u$u -L list-closed-array-empty-val-array-basic.old <(echo \
...
[
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":[]}]}'\'' <<< '\''[[]]'\'''
) -L list-closed-array-empty-val-array-basic.new <(
