...
# $ json-gentest -C type-checker-list:list-basic-object-plain-val-object-empty
#
...
diff -u$u -L list-basic-object-plain-val-object-empty.old <(echo \
...
) -L list-basic-object-plain-val-object-empty.new <(
