...
# $ json-gentest -C type-checker-list:list-closed-array-basic-val-basic
#
...
diff -u$u -L list-closed-array-basic-val-basic.old <(echo \
...
[
command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["array"]}]}'\'' <<< '\''[]'\'''
) -L list-closed-array-basic-val-basic.new <(
