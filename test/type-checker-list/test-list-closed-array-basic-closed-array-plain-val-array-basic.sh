...
# $ json-gentest -C type-checker-list:list-closed-array-basic-closed-array-plain-val-array-basic
#
...
diff -u$u -L list-closed-array-basic-closed-array-plain-val-array-basic.old <(echo \
...
$ json -d '\''{"type":"list","args":[{"type":"array","args":["array"]},{"type":"array","args":[{"plain":"foo"}]}]}'\'' <<< '\''[[]]'\''
[[]]'
) -L list-closed-array-basic-closed-array-plain-val-array-basic.new <(
