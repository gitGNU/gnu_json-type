...
# $ json-gentest -C type-checker-list:list-closed-array-basic-closed-array-basic-val-array-empty
#
...
diff -u$u -L list-closed-array-basic-closed-array-basic-val-array-empty.old <(echo \
...
) -L list-closed-array-basic-closed-array-basic-val-array-empty.new <(
