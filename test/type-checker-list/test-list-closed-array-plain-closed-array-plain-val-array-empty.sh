...
# $ json-gentest -C type-checker-list:list-closed-array-plain-closed-array-plain-val-array-empty
#
...
diff -u$u -L list-closed-array-plain-closed-array-plain-val-array-empty.old <(echo \
...
) -L list-closed-array-plain-closed-array-plain-val-array-empty.new <(
