...
# $ json-gentest -C type-gen-def-gcc:node-dict-closed-array-any2
#
...
diff -u$u -L node-dict-closed-array-any2.old <(echo \
'$ set -o pipefail
...
static const struct json_type_dict_node_arg_t __15[] = {
    {
...
) -L node-dict-closed-array-any2.new <(
echo '$ set -o pipefail'
set -o pipefail 2>&1 ||
