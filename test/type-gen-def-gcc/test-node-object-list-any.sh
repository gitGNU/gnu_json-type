...
# $ json-gentest -C type-gen-def-gcc:node-object-list-any
#
...
diff -u$u -L node-object-list-any.old <(echo \
'$ set -o pipefail
...
echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["type"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["type"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["type"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["null"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["null"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["null"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["boolean"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["boolean"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["boolean"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["number"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["number"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["number"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["string"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["string"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["string"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["object"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["object"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["object"]}}]}'\'''

echo '$ json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["array"]}}]}'\'''
json <<< '{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["array"]}}]}' 2>&1 ||
echo 'command failed: json <<< '\''{"type":"object","args":[{"name":"foo","type":{"type":"list","args":["array"]}}]}'\'''
)
