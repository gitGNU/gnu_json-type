...
echo '$ json -t <(echo '\''{"type":"list","args":["number",{"type":"array","args":"number"}]}'\'') <<< '\''[1]'\'''
json -t <(echo '{"type":"list","args":["number",{"type":"array","args":"number"}]}') <<< '[1]' 2>&1 ||
echo 'command failed: json -t <(echo '\''{"type":"list","args":["number",{"type":"array","args":"number"}]}'\'') <<< '\''[1]'\'''
)
