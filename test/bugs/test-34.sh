...
echo '$ echo -e '\''"\xf1\x80\x80\x80""a\xe1\x80"'\''|json -luV -mO'
echo -e '"\xf1\x80\x80\x80""a\xe1\x80"'|json -luV -mO 2>&1 ||
echo 'command failed: echo -e '\''"\xf1\x80\x80\x80""a\xe1\x80"'\''|json -luV -mO'
)
