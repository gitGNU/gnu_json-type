...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":["number"]},{"type":"array","args":["number","number"]}]}'\'' <<< '\''[1,2]'\'''
json -d '{"type":"list","args":[{"type":"array","args":["number"]},{"type":"array","args":["number","number"]}]}' <<< '[1,2]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":["number"]},{"type":"array","args":["number","number"]}]}'\'' <<< '\''[1,2]'\'''
)
