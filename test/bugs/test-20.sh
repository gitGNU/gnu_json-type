...
echo '$ json -d '\''{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}'\'' <<< '\''[0]'\'''
json -d '{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}' <<< '[0]' 2>&1 ||
echo 'command failed: json -d '\''{"type":"list","args":[{"type":"array","args":{"type":"list","args":["number"]}}]}'\'' <<< '\''[0]'\'''
)
