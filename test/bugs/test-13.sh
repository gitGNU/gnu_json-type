...
echo '$ json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":"type"},{"type":"array","args":"array"}]}'\'''
json -Tc <<< '{"type":"list","args":[{"type":"array","args":"type"},{"type":"array","args":"array"}]}' 2>&1 ||
echo 'command failed: json -Tc <<< '\''{"type":"list","args":[{"type":"array","args":"type"},{"type":"array","args":"array"}]}'\'''
)
