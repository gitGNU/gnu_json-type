...
echo '$ json -t <(echo '\''{"type":"list","args":[{"type":"array","args":[{"plain":0}]}]}'\'') <<< '\''[0]'\'''
json -t <(echo '{"type":"list","args":[{"type":"array","args":[{"plain":0}]}]}') <<< '[0]' 2>&1 ||
echo 'command failed: json -t <(echo '\''{"type":"list","args":[{"type":"array","args":[{"plain":0}]}]}'\'') <<< '\''[0]'\'''
)
