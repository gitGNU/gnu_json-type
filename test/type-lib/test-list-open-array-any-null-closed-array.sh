...
# $ json-gentest -C type-lib:list-open-array-any-null-closed-array
#
...
diff -u$u -L list-open-array-any-null-closed-array.old <(echo \
...
) -L list-open-array-any-null-closed-array.new <(
