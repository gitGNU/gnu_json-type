...
# $ json-gentest -C type-lib:list-closed-array-array-closed-array-any-string
#
...
diff -u$u -L list-closed-array-array-closed-array-any-string.old <(echo \
...
) -L list-closed-array-array-closed-array-any-string.new <(
