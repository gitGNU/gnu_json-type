...
# $ json-gentest -C type-lib:list-open-array-any-string-closed-array
#
...
diff -u$u -L list-open-array-any-string-closed-array.old <(echo \
...
) -L list-open-array-any-string-closed-array.new <(
