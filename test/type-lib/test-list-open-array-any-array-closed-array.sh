...
# $ json-gentest -C type-lib:list-open-array-any-array-closed-array
#
...
diff -u$u -L list-open-array-any-array-closed-array.old <(echo \
...
) -L list-open-array-any-array-closed-array.new <(
