...
# $ json-gentest -C type-lib:list-closed-array-any-array-closed-array-any-number
#
...
diff -u$u -L list-closed-array-any-array-closed-array-any-number.old <(echo \
...
) -L list-closed-array-any-array-closed-array-any-number.new <(
