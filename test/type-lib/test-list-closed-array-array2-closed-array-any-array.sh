...
# $ json-gentest -C type-lib:list-closed-array-array2-closed-array-any-array
#
...
diff -u$u -L list-closed-array-array2-closed-array-any-array.old <(echo \
...
) -L list-closed-array-array2-closed-array-any-array.new <(
