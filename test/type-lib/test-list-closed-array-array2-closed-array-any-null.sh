...
# $ json-gentest -C type-lib:list-closed-array-array2-closed-array-any-null
#
...
diff -u$u -L list-closed-array-array2-closed-array-any-null.old <(echo \
...
) -L list-closed-array-array2-closed-array-any-null.new <(
