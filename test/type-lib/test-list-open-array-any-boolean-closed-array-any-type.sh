...
# $ json-gentest -C type-lib:list-open-array-any-boolean-closed-array-any-type
#
...
diff -u$u -L list-open-array-any-boolean-closed-array-any-type.old <(echo \
...
) -L list-open-array-any-boolean-closed-array-any-type.new <(
