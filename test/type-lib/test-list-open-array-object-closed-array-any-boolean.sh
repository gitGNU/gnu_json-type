...
# $ json-gentest -C type-lib:list-open-array-object-closed-array-any-boolean
#
...
diff -u$u -L list-open-array-object-closed-array-any-boolean.old <(echo \
...
) -L list-open-array-object-closed-array-any-boolean.new <(
