...
# $ json-gentest -C type-lib:list-open-array-any-number-closed-array
#
...
diff -u$u -L list-open-array-any-number-closed-array.old <(echo \
...
) -L list-open-array-any-number-closed-array.new <(
