...
# $ json-gentest -C type-lib:list-open-array-any-number-closed-array-any-object
#
...
diff -u$u -L list-open-array-any-number-closed-array-any-object.old <(echo \
...
) -L list-open-array-any-number-closed-array-any-object.new <(
