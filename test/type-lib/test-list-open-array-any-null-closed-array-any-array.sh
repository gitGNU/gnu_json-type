...
# $ json-gentest -C type-lib:list-open-array-any-null-closed-array-any-array
#
...
diff -u$u -L list-open-array-any-null-closed-array-any-array.old <(echo \
...
) -L list-open-array-any-null-closed-array-any-array.new <(
