...
# $ json-gentest -C type-lib:list-closed-array-any-null-closed-array-object
#
...
diff -u$u -L list-closed-array-any-null-closed-array-object.old <(echo \
...
) -L list-closed-array-any-null-closed-array-object.new <(
