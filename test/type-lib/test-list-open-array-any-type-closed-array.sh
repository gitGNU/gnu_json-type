...
# $ json-gentest -C type-lib:list-open-array-any-type-closed-array
#
...
diff -u$u -L list-open-array-any-type-closed-array.old <(echo \
...
) -L list-open-array-any-type-closed-array.new <(
