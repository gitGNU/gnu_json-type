...
# $ json-gentest -C type-lib:list-closed-array-array-closed-array
#
...
diff -u$u -L list-closed-array-array-closed-array.old <(echo \
...
) -L list-closed-array-array-closed-array.new <(
