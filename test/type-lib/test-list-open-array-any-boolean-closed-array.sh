...
# $ json-gentest -C type-lib:list-open-array-any-boolean-closed-array
#
...
diff -u$u -L list-open-array-any-boolean-closed-array.old <(echo \
...
) -L list-open-array-any-boolean-closed-array.new <(
